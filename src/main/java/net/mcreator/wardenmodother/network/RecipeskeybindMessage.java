...
import net.mcreator.wardenmodother.procedures.RecipeskeybindOnKeyPressedProcedure;
...
public class RecipeskeybindMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		WardenModotherMod.addNetworkMessage(RecipeskeybindMessage.class, RecipeskeybindMessage::buffer, RecipeskeybindMessage::new, RecipeskeybindMessage::handler);
	}
}
