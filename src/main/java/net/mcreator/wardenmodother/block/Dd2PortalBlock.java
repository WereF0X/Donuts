...
import net.mcreator.wardenmodother.world.teleporter.Dd2Teleporter;
import net.mcreator.wardenmodother.world.teleporter.Dd2PortalShape;

import java.util.Optional;

public class Dd2PortalBlock extends NetherPortalBlock {
	public Dd2PortalBlock() {
	...
	public static void portalSpawn(Level world, BlockPos pos) {
		Optional<Dd2PortalShape> optional = Dd2PortalShape.findEmptyPortalShape(world, pos, Direction.Axis.X);
	...
	public BlockState updateShape(BlockState p_54928_, Direction p_54929_, BlockState p_54930_, LevelAccessor p_54931_, BlockPos p_54932_, BlockPos p_54933_) {
		...
		return !flag && !p_54930_.is(this) && !(new Dd2PortalShape(p_54931_, p_54932_, direction$axis1)).isComplete() ? Blocks.AIR.defaultBlockState() : super.updateShape(p_54928_, p_54929_, p_54930_, p_54931_, p_54932_, p_54933_);
	}
	...
	public void animateTick(BlockState state, Level world, BlockPos pos, RandomSource random) {
		for (int i = 0; i < 4; i++) {
			...
			world.addParticle(ParticleTypes.GLOW, px, py, pz, vx, vy, vz);
		}
	...
	public void entityInside(BlockState state, Level world, BlockPos pos, Entity entity) {
		if (entity.canChangeDimensions() && !entity.level().isClientSide() && true) {
			...
			} else if (entity.level().dimension() != ResourceKey.create(Registries.DIMENSION, new ResourceLocation("warden_modother:dd_2"))) {
				entity.setPortalCooldown();
				teleportToDimension(entity, pos, ResourceKey.create(Registries.DIMENSION, new ResourceLocation("warden_modother:dd_2")));
			} else {
				entity.setPortalCooldown();
	...
	private void teleportToDimension(Entity entity, BlockPos pos, ResourceKey<Level> destinationType) {
		entity.changeDimension(entity.getServer().getLevel(destinationType), new Dd2Teleporter(entity.getServer().getLevel(destinationType), pos));
	}
}
